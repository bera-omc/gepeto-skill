...
When a source is too large to attach as one file (a long policy doc, a PDF, a research paper), chunk it. The included helper `tools/pdf-to-chunks.py` implements the defaults below.
